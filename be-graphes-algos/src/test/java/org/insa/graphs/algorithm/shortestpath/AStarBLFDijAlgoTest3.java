...
import org.insa.graphs.algorithm.Chronometre;
...
public class AStarBLFDijAlgoTest3 {
	...
	public static void InitAll() throws Exception {
		GraphReader reader = new BinaryGraphReader(new DataInputStream( new BufferedInputStream(new FileInputStream("C:/Users/leoni/Documents/graphes/BE_graphes/cartes/insa.mapgr"))));
        Graph graph = reader.read();
        
        PathReader pathreader_short=new BinaryPathReader(new DataInputStream(new BufferedInputStream(new FileInputStream("C:/Users/leoni/Documents/graphes/BE_graphes/path/path_fr31insa_rangueil_r2.path"))));
        short_path=pathreader_short.readPath(graph);
        
        PathReader pathreader_long=new BinaryPathReader(new DataInputStream(new BufferedInputStream(new FileInputStream("C:/Users/leoni/Documents/graphes/BE_graphes/path/path_fr31insa_rangueil_insa.path"))));
        ...
        dataD0_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(0) );
        ...
        dataD2_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(2) );
        ...
        dataAS0_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(0) );
        ...
        dataAS2_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(2) );
        ...
        dataBLF0_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(0) );
        ...
        dataBLF2_impossible =new ShortestPathData(graph, graph.get(953), graph.get(735), ArcInspectorFactory.getAllFilters().get(2) );
        ...
        public void AStarTest() {
         ...
         //   BellmanFordAlgorithm D_A_2_singleBLF=new BellmanFordAlgorithm(dataBLF2_single);
            ...
            Chronometre chrono2=new Chronometre();
            Chronometre chrono3=new Chronometre();
        ...
        //    assertEquals(chrono.getDureeMs(),chrono2.getDureeMs()); in average, BLF longer than AS
         //   assertEquals(chrono.getDureeMs(),chrono3.getDureeMs()); in average, BLF longer than D
          //  assertEquals(chrono2.getDureeMs(),chrono3.getDureeMs());in average AS quicker than D
         ...
         //   assertEquals(chrono.getDureeMs(),chrono2.getDureeMs()); in average BLF longer than AS
         //   assertEquals(chrono.getDureeMs(),chrono3.getDureeMs()); in average BLF quicker than D
          //  assertEquals(chrono2.getDureeMs(),chrono3.getDureeMs()); in average AS quicker than D
          ...
          //  assertEquals(chrono.getDureeMs(),chrono2.getDureeMs()); in average BLF quicker than AS 
         //   assertEquals(chrono.getDureeMs(),chrono3.getDureeMs()); in average same (BLF et D)
            //assertEquals(chrono2.getDureeMs(),chrono3.getDureeMs()); in average AS longer than D
          ...
          //  assertEquals(chrono2.getDureeMs(),chrono3.getDureeMs()); in average AS longer than D
            ...
            //assertEquals(solBLF.getPath().size(),solAS.getPath().size());  expected 35 but was 33
            assertEquals(solBLF.getPath().size(),solD.getPath().size());
